...
### **Цель:** Uplift-моделирование методом T-Leaner с целью оптимизации таргетинга и формирования стратегий по повышению конвертаций
...
2.	treatment - метка группы, где: 1 - предпринята попытка показать рекламу пользователю, 0 – пользователь в контрольной группе (без рекламы);
